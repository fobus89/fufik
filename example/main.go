...
import (
	...
	"github.com/fobus89/fufik/example/parser/parse_arithmetic"
	"github.com/fobus89/fufik/example/parser/parse_literal"
...
func main() {
	...
	parse_arithmetic.RegisterParser(p)
	parse_literal.RegisterParser(p)
